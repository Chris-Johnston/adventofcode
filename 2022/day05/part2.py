...
while True:
    ...
    # get the last n crates from the list
    # only part to change for pt 2
    in_transit = stacks[mfrom][-mcount:]
    # remove items in transit
    stacks[mfrom] = stacks[mfrom][:len(stacks[mfrom]) - mcount]

    stacks[mto] = stacks[mto] + in_transit
